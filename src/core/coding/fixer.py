...
from src.ai.gateway import get_gateway, AIMessage, AICapability
...
class FixGenerator:
    ...
    async def analyze_issue(self, title: str, body: str, file_list: list[str]) -> Optional[str]:
    ...
    async def generate_fix(self, title: str, body: str, file_content: str, filename: str) -> Optional[str]:
