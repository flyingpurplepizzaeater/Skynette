...
must_haves:
  truths:
    ...
    - "Provider selection persists across chat sessions"
  artifacts:
...
<task type="auto">
  <name>Task 1: Add AI panel to CodeEditorView with toggle</name>
  <files>
    src/ui/views/code_editor/__init__.py
    src/ui/views/code_editor/toolbar.py
  </files>
  <action>
    Integrate ChatPanel into CodeEditorView:
...
"
  ...
  <done>AI chat panel integrated with toggle button in toolbar, panel appears on right side of editor</done>
</task>
...
7. All components properly disposed on view cleanup
</success_criteria>
